...
import { allAssignedEquipment, createAssignment, getHistoryByEquipment, getAssignedEquipmentUser, markAsReturned, completePayment } from "../controllers/assignmentHistory.controller.js";
...
router.route("/complete-payment").patch(completePayment);
