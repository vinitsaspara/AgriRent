    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-5xl flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-4">
              Modern <span className="text-emerald-600">Agricultural</span>{" "}
              Equipment Rental
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <button
                className="bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 px-6 rounded-md cursor-pointer transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Choose from our wide range of well-maintained agricultural
                equipment
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Select your rental dates and complete payment securely online
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Collect your equipment and get farming with our support team on
                standby
              </p>
            </div>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl bg-emerald-50 rounded-2xl p-8 md:p-12">
          <div className="flex flex-col items-center text-center">
            <svg
              className="w-12 h-12 text-emerald-300 mb-6"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 italic">
              "AgriRent has transformed how we manage our seasonal equipment
              needs. The quality of machinery and the ease of rental process
              have saved us both time and money."
            </p>
            <div>
      ...
      <section className="py-16 px-4 bg-emerald-600">
        <div className="container mx-auto max-w-5xl text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to optimize your farming operations?
          </h2>
          <p className="text-xl text-emerald-100 mb-8 max-w-3xl mx-auto">
            Join thousands of farmers who trust AgriRent for their equipment
            needs
          </p>
